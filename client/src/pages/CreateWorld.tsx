...
export default function CreateWorld() {
  ...
  useEffect(() => {
    ...
    if (!token) {
      toast.error("Please log in to create worlds");
      setLocation("/");
    }
  }, [setLocation]);
      ...
      <div className="relative z-10 flex flex-col items-center justify-center px-4 py-20">
        <div className="max-w-2xl w-full text-center">
          <h2 className="text-5xl font-bold mb-4 text-white">
            <span className="neon-text-cyan">Create World</span>
          </h2>
          <p className="text-gray-400 text-xl mb-8">
            World creation coming soon
          </p>
          <div className="bg-[#0d1230] border border-gray-800 rounded-xl p-12 mb-8">
            <div className="text-6xl mb-6">🎨</div>
            <p className="text-gray-300 text-lg mb-2">
              Build your dream world from scratch.
            </p>
            <p className="text-gray-500">
              Our world creation tools are under development. Soon you'll be able to design and publish your own worlds!
            </p>
          </div>
          <Button
            onClick={() => setLocation("/home")}
